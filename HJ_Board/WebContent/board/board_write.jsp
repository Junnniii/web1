	...
	<h1> 게시판 글쓰기 </h1>
		...
		<fieldset>
			...
			<p>
				...
				<textarea id="subject" name="subject" cols="74" rows="1" required placeholder="제목의 내용을 입력하세요.">
				</textarea>	
			</p>
			<p>
			...
			<p>
				...
				<input type="file" id="attached_file" name="attacehd_file" placeholder="파일 첨부"/>
			</p>
			<div class ="bntJoinArea">
